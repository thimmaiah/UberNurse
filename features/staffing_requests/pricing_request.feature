...
Scenario Outline: Pricing Request on Weekend
  ...
  Examples:
    |care_home    |admin      |request                              |start_time |end_time    |rate|price |
    |verified=true|role=Admin |role=Care Giver;speciality=Generalist|{hour:8}   |{hour:14}   |10  |72    |
    |verified=true|role=Admin |role=Care Giver;speciality=Generalist|{hour:8}   |{hour:18}   |10  |120   |
    |verified=true|role=Admin |role=Nurse;speciality=Generalist     |{hour:7}   |{hour:17}   |12  |145   |
    |verified=true|role=Admin |role=Nurse;speciality=Mental Health  |{hour:20}  |{hour:23}   |15  |59    |
    |verified=true|role=Admin |role=Nurse;speciality=Mental Health  |{hour:0 }  |{hour:8}    |10  |104   |

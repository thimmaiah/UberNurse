...
ActiveRecord::Schema.define(version: 20181110081553) do
  ...
  create_table "referrals", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.integer  "agency_id"
    t.index ["agency_id"], name: "index_referrals_on_agency_id", using: :btree
  ...
  create_table "user_docs", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.integer  "agency_id"
    t.index ["agency_id"], name: "index_user_docs_on_agency_id", using: :btree

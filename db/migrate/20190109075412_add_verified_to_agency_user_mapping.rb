class AddVerifiedToAgencyUserMapping < ActiveRecord::Migration[5.0]
  def change
    add_column :agency_user_mappings, :verified, :boolean
    ...
    add_column :agency_care_home_mappings, :limit_shift_to_pref_carer, :boolean    
  end
end

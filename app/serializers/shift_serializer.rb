class ShiftSerializer < ActiveModel::Serializer
  ...
  :end_code, :end_date, :response_status, :minutes_worked, :price, :total_price, :markup, 
  :vat, :billing, :pricing_audit, :viewed,
  :accepted, :rated, :care_home_rated, :user, :ratings, :care_home_id, :care_home, :staffing_request, 
  :payment, :payment_status, :care_home_payment_status, :can_manage
